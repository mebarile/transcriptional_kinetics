function main_model2(n,reg,pop1,pop2,model)
...
filename = ['./data_output/parameters_' num2str(n) '_' num2str(model) '_model2_reg' num2str(reg) '_' num2str(pop1) '_' num2str(pop2) '.mat'];
...
modelfun = @ simulate_kinetics_model2;
...
objectiveFunction = @(theta) llKin_model2(theta,modelfun,D,pop1,pop2,options);
