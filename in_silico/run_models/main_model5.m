function main_model5(n,reg,pop1,pop2,model)

addpath(genpath('./matlab_simulations/'))

rng(1)

filename = ['./data_output/parameters_' num2str(n) '_' num2str(model) '_model5_reg' num2str(reg) '_' num2str(pop1) '_' num2str(pop2) '.mat'];
...
modelfun = @ simulate_kinetics_model5;
...
data2 = load(['./data_output/parameters_' num2str(n) '_'  num2str(model) '_model2_reg' num2str(reg) '_' num2str(pop1) '_' num2str(pop2) '.mat']);
b2 = data2.parameters.MS.logPost(1);


data3 = load(['./data_output/parameters_' num2str(n) '_'  num2str(model) '_model3_reg' num2str(reg) '_' num2str(pop1) '_' num2str(pop2) '.mat']);
...
objectiveFunction = @(theta) llKin_model5(theta,modelfun,D,pop1,pop2,options);
