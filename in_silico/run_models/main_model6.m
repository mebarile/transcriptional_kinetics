function main_model6(n,reg,pop1,pop2,model)
...
filename = ['./data_output/parameters_' num2str(n) '_' num2str(model) '_model6_reg' num2str(reg) '_' num2str(pop1) '_' num2str(pop2) '.mat'];
