function main_model3_samples(n,reg)
...
filename = ['./data_output_all_samples/parameters_' gene_name '_model3_all_samples_reg' num2str(reg) '.mat'];
...
modelfun = @ simulate_kinetics_model3_all_samples;
...
objectiveFunction = @(theta) llKin_model3_all_samples(theta,modelfun,D,options);
