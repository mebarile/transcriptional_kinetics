function main_model6_samples(n,reg)
...
filename = ['./data_output_all_samples/parameters_' gene_name '_model6_all_samples_reg' num2str(reg)  '.mat'];
...
modelfun = @ simulate_kinetics_model6_all_samples;
...
data2 = load(['./data_output_all_samples/parameters_' gene_name '_model2_all_samples_reg' num2str(reg) '.mat']);
...
objectiveFunction = @(theta) llKin_model6_all_samples(theta,modelfun,D,options);
