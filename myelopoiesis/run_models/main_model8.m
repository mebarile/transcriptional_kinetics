...
filename = ['./data_output/parameters_' gene_name '_model8_reg' num2str(reg) '_' num2str(pop1) '_' num2str(pop2) '.mat'];
...
data5 = load(['./data_output/parameters_' gene_name '_model5_reg' num2str(reg) '_' num2str(pop1) '_' num2str(pop2) '.mat']);
b5 = data5.parameters.MS.logPost(1);


data6 = load(['./data_output/parameters_' gene_name '_model6_reg' num2str(reg) '_' num2str(pop1) '_' num2str(pop2) '.mat']);
b6 = data6.parameters.MS.logPost(1);


data7 = load(['./data_output/parameters_'  gene_name '_model7_reg' num2str(reg) '_' num2str(pop1) '_' num2str(pop2) '.mat']);
