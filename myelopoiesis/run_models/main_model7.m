...
filename = ['./data_output/parameters_' gene_name '_model7_reg' num2str(reg) '_' num2str(pop1) '_' num2str(pop2) '.mat'];
...
data3 = load(['./data_output/parameters_' gene_name  '_model3_reg' num2str(reg) '_' num2str(pop1) '_' num2str(pop2) '.mat']);
